...
| `opencode` | OpenCode | `~/.config/opencode`, `~/.local/share/opencode/auth.json` (Go `/connect` key) | OpenCode Go 5-hour / weekly / monthly via `GET /zen/go/v1/usage`, plus local session totals |
